      ...
      <Card>
        <CardContent className={classes.productContainer}>
          <div className={classes.productDetails}>
            <img src={product.image} alt={product.name} className={classes.productImage}  style={{border: "solid 5px #D8DDDE"}}/>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <Typography variant="h4" gutterBottom>
              {product.name}
            </Typography>
            <Typography variant="body1" gutterBottom style={{ fontSize: '2.5rem', fontWeight: '700', color: '#333' }}>
